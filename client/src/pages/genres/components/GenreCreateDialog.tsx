...
export default function GenreCreateDialog({
  ...
  const generateMutation = useMutation({
    ...
    onSuccess: (response) => {
      ...
      toast.success(t("createDialog.generateSuccess"));
    },
  });
      ...
      <DialogContent className="max-h-[90vh] max-w-4xl overflow-auto">
        ...
        <div className="space-y-4">
          <div className="space-y-3 rounded-xl border border-primary/20 bg-primary/5 p-4">
            <div className="space-y-1">
              <div className="text-sm font-semibold text-foreground">{t("createDialog.aiGenerate.title")}</div>
              <div className="text-xs leading-5 text-muted-foreground">
                {t("createDialog.aiGenerate.hint")}
              </div>
            </div>
            <LLMSelector />
            <textarea
              ...
              placeholder={t("createDialog.aiGenerate.placeholder")}
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                {generateMutation.isPending ? t("createDialog.aiGenerate.generating") : t("createDialog.aiGenerate.generate")}
              </Button>
              <Button
                type="button"
                variant="outline"
              ...
              >
                {t("createDialog.aiGenerate.reset")}
              </Button>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              <option value="">{t("createDialog.noParent")}</option>
        ...
        <DialogFooter className="gap-2">
          ...
          <Button type="button" onClick={() => createMutation.mutate()} disabled={!canSubmit || createMutation.isPending}>
            {createMutation.isPending ? t("createDialog.saving") : t("createDialog.save")}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
