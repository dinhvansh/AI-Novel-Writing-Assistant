...
function formatTaskStatus(status: string | null | undefined, t: (key: string) => string): string {
          ...
          {!collapsed ? (
            ...
            <div className="flex flex-col items-center gap-2">
              <Button
                ...
                title={t("novel:workspace.rail.viewProgress", { status: formatTaskStatus(activeTask?.status, t) })}
